...
$('<style type="text/css"> .thb-large-box .thb_cell_v1 a:link, .thb-large-box .thb_c2 {margin: 0px !important;} </style>').appendTo("head");
...
function arrangeImagesOneContainer(count, imgSizes) {
  ...
  var minSize = (typeof displayPinMaxRows != "undefined" && displayPinMaxRows == 1) ? 50 : 100;
  ...
  var maxS = (typeof displayPinMaxRows != "undefined" && displayPinMaxRows == 1) ? 2.5 : 16 / 9; // 1.6; // 1.78;
  //var maxS = (typeof displayPinMaxRows != "undefined" && displayPinMaxRows == 1) ? 2.5 : 1.6; // 16 / 9; // 1.78;
  if (location.href.match(/maxs=([\d\.]+)/)) {
    maxS = RegExp.$1 - 0;
  }
  var maxVS = (typeof displayPinMaxRows != "undefined" && displayPinMaxRows == 1) ? 2.5 : 1920 / 1080; // 16 / 9;
    ...
    if (drawRow) {
      ...
      for (var j = 0; j < row.length; j++) {
        ...
        if (rid == "nextbutton") {
          ...
          if (typeof displayPinMaxRows != "undefined" && rows >= displayPinMaxRows) {
